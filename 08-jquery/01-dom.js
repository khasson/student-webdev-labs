...
$(document).ready(function () {
  //Fetch elements and add an event listener using jQuery
  $("#copy").click(function (event) {
    //Logging the click event to the console
    console.log("click event", event);
    //Copy the user input to the output area
...
$(document).ready(function () {
  //Add an event listener for the 'input' event using jQuery
  $("#userInput2").on("input", function (event) {
    //Log the input event to the console
